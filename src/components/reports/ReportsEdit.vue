<template>
  <div class="report-edit">
    ...
    <div v-else class="report-edit__content">
      <section class="report-edit__hero">
        <div class="report-edit__hero-content">
          <p class="report-edit__eyebrow">
            {{ t("reports.title") }}
          </p>

          <h1 class="report-edit__hero-title">
            تعديل التقرير بشكل مرتب وواضح
          </h1>

          <p class="report-edit__hero-text">
            عدّل بيانات التقرير، وراجع التوصيات وخطة الأسابيع، وبعدها احفظ
            التغييرات بنفس الهوية الزرقا بتاعة النظام.
          </p>
        </div>
      ...
      <section class="report-edit__section">
        <div class="report-edit__section-head">
          <h2 class="report-edit__section-title">بيانات التقرير الأساسية</h2>
        </div>
      ...
      >
        <div class="report-edit__section-head">
          <h2 class="report-edit__section-title">خطة الأسابيع</h2>
        </div>

        <div class="report-edit__weeks">
          <BaseStyledSection
            v-for="(week, weekIndex) in report.report_weeks"
            :key="weekIndex"
            class="report-edit__week-shell"
          >
            <template #label>
              <div class="report-edit__week-header">
                <h3 class="report-edit__week-title">
                  {{ t(`reports.form.options.week_number.${week.week_number}`) }}
                </h3>

                <span class="report-edit__week-dates">
                  {{
                    week.days && week.days.length
            ...
            <div class="report-edit__rows">
              ...
              >
                <template #default="{ v }">
                  <div class="report-edit__row-card">
                    <BaseAccordion variant="splitted">
                      <BaseAccordionItem
                        :key="row.day"
                        :title="`${row.day} - ${row.date}`"
                      >
                        <div class="report-edit__day-content">
                          <section class="report-edit__sub-section">
                            <div class="report-edit__sub-head">
                              <h4 class="report-edit__sub-title">التسميد</h4>
                            </div>
                          ...
                          <section class="report-edit__sub-section">
                            <div class="report-edit__sub-head">
                              <h4 class="report-edit__sub-title">الري</h4>
                            </div>
                          ...
                          <section class="report-edit__sub-section">
                            <div class="report-edit__sub-head">
                              <h4 class="report-edit__sub-title">الرش</h4>
                            </div>
      ...
      <section class="report-edit__actions-shell">
        <div class="report-edit__actions">
          <BaseButton
            class="report-edit__action"
            color="gray"
            variant="outline"
            size="sm"
            @click="navigateBack"
...
:deep(.report-edit__field-card .base-input),
:deep(.report-edit__field-card .base-select),
:deep(.report-edit__field-card .base-date-picker),
:deep(.report-edit__field-card .base-text-editor) {
  width: 100%;
}
