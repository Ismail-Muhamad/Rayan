                  ...
                  >
                    <div class="report__fields">
                      <div class="report__section">
                        ...
                        >
                          <template #default="{ v }">
                            <div class="report__row report__row--fertilization">
                              <BaseInput
                                :label="
                                  t('reports.form.labels.type_of_fertilization')
                                "
                                :placeholder="
                                  t(
...
const submitForm = async () => {
  ...
  const reponse = await reportsStore.createRecord(report.value);
};
const resetForm = () => {
  report.value = {
    owner: null,
